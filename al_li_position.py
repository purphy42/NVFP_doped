...
# print(db['al_li_position2', '9_bulk_mp', 1].e0)
# print(db['al_li_position3', '9_bulk_mp', 1].e0)
...
if 0:
    ...
    res_loop('al_one_al_na.su', '9_bulk_eos', list(range(1,11)) + [100], show = 'fit', analys_type = 'fit_a', al_two_al_two_nacluster = 'razor128',)
